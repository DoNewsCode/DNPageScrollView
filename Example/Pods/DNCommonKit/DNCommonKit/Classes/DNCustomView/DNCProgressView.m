...
#pragma mark - DNCProgressLayer

@interface DNCProgressLayer : CALayer
...
@implementation DNCProgressLayer {
...
@implementation DNCProgressView

+ (Class)layerClass {
    return [DNCProgressLayer class];
}
...
- (void)setProgress:(float)progress animated:(BOOL)animated {
    ...
    DNCProgressLayer *layer = (DNCProgressLayer *)self.layer;
    layer.progress = _progress;
    [(DNCProgressLayer *)self.layer setProgressWithAnimated:animated];
}
